...
public class InterfazCalculadora extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Calculadora/Fondo Negro.jpeg"))); // NOI18N
        jLabel2.setText("jLabel1");

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Calculadora/Fondo Negro.jpeg"))); // NOI18N
        jLabel4.setText("jLabel1");

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Calculadora/Fondo Negro.jpeg"))); // NOI18N
        jLabel5.setText("jLabel1");

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Calculadora/Fondo Negro.jpeg"))); // NOI18N
        jLabel1.setText("jLabel1");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Calculadora/Fondo Negro.jpeg"))); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Calculadora/Fondo Negro.jpeg"))); // NOI18N
        jLabel6.setText("jLabel1");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(-10, -20, 330, 310);

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Calculadora/Fondo Negro.jpeg"))); // NOI18N
        jLabel7.setText("jLabel1");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(-10, 160, 330, 310);

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Calculadora/Fondo Negro.jpeg"))); // NOI18N
        jLabel8.setText("jLabel1");
        getContentPane().add(jLabel8);
        jLabel8.setBounds(100, 180, 330, 310);

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Calculadora/Fondo Negro.jpeg"))); // NOI18N
        jLabel9.setText("jLabel1");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(100, -30, 330, 310);
    ...
    private void btnMultiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMultiActionPerformed
        try {
            ...
            calculadora.setPrimerNumero(num);
...
Pantalla.setText(" ");
    ...
    private void btnIgualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIgualActionPerformed
        try {
            double num = Double.parseDouble(Pantalla.getText());
            calculadora.setSegundoNumero(num);
            double resultado = calculadora.calcular();
            Pantalla.setText(String.valueOf(resultado));
        } catch (NumberFormatException e) {
            Pantalla.setText("Error formato");
        } catch (ArithmeticException e) {
            Pantalla.setText("Error matemático");
        } catch (Exception e) {
            Pantalla.setText("Error");
        }
    ...
    private void btnIVAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIVAActionPerformed
        ...
        calculadora.setPrimerNumero(num);
        calculadora.setSegundoNumero(porcentajeIVA);
        double resultado = calculadora.calcular();
        Pantalla.setText(String.valueOf(resultado));
    } catch (NumberFormatException e) {
        Pantalla.setText("Error");
    ...
    private void btnPotenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPotenciaActionPerformed
        ...
        calculadora.setPrimerNumero(num);
        calculadora.setSegundoNumero(exponente);
        calculadora.setOperador("^");
        double resultado = calculadora.calcular();
        Pantalla.setText(String.valueOf(resultado));
    } catch (NumberFormatException e) {
